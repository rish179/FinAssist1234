...
class Stock_News:
    ...
    def fetch_yahoo_finance_news_today(self, stock_symbol, count=5):
        ...
        for section in article_sections:
            try:
                ...
                if not any(keyword in timestamp.lower() for keyword in
                           ["hour ago", "hours ago", "minute ago", "minutes ago", "today"]):
                ...
                link = 'https://finance.yahoo.com' + a_tag['href'] if a_tag and a_tag['href'].startswith('/') else \
                a_tag['href']
    ...
    def fetch_twitter_news_today(self, stock_symbol, count=10):
